...
> **Note (2026-07-14):** The [incident design](../../../docs/design/app/incidents.md)
> supersedes the Pi-lock dependency for voice incident marking. If voice marking lands,
> the App Intent creates the same durable phone-local incident record as the on-screen
> press and lets the app reconciler pull it from existing clip surfaces. There is no Pi
> call on the press path, improving the latency and offline-retry story while leaving
> this ADR's CarPlay surface unchanged.
